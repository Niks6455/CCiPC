export default {
    registration: {
        ...
        template: (code) =>
            `<h1>Здравствуйте! Код для подтвержения почты на платформе ССиПС.</h1>
...
<p><strong>${process.env.WEB_URL}</strong></p>`,
    ...
    assignFee: {
        ...
        template: (fio, fee) =>  `<h1>Здравствуйте! Уважаемый ${fio}, ваш доклад на конфиренция "Системный синтез и прикладная синергетика" принят. Сообщаем, что оплата оргвзноса в размере ${fee} рублей можно оплатить либо наличными либо безналичным расчетом.</h1>
